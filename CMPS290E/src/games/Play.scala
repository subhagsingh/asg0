...
/* This file contains the singleton object containing main method as entry point for the project.
 * Also, all the requirements provided by command line arguments are processed here to update the
 * fields of GameOfLife accordingly.
 */
object Play {
